...
if __name__ == "__main__":
    ...
    named_entities = NameTagging.name_tagging(review)
    ...
    for entity in named_entities:
        if algo_type == "-l":
            ...
            all_predictions,all_scores = getSentiment.getSentimentRNN("actor_sentences",'1524375413')
            sentiment = (all_predictions, all_scores)
